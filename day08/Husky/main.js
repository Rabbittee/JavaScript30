var Canvas = /** @class */ (function () {
  ...
  Canvas.prototype.initEvent = function () {
    ...
    this.penSize.addEventListener('change', function (e) {
      return _this.updateSize(e.target);
    });
    ...
    this.canvas.addEventListener('pointerup', function () {
      return (_this.drawFlag = false);
    });
    this.canvas.addEventListener('pointerout', function () {
      return (_this.drawFlag = false);
    });
  ...
  Canvas.prototype.updateSize = function (target) {
    ...
    this.inputStyle.innerHTML =
      "\n      input[type='range']::-webkit-slider-thumb {\n        -webkit-appearance: none;\n        height: "
        .concat(Number(target.value), 'px;\n        width: ')
        .concat(Number(target.value), 'px;\n        border-radius: 50%;\n        background: ')
        .concat(this.colorPicker.value, ';\n        cursor: ew-resize;\n      }\n    ');
  };
