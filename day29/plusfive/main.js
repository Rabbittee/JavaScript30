...
var selectEvery = function (query) {
...
function display(seconds) {
  ...
  select('.display__time-left').innerText = '\n    '
    .concat(hours < 10 ? showTens(hours) : hours, ':')
    .concat(minutes < 10 ? showTens(minutes) : minutes, ':')
    .concat(remainderSeconds < 10 ? showTens(remainderSeconds) : remainderSeconds, '\n  ');
}
